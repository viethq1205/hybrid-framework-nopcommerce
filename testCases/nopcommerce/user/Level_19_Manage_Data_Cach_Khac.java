...
public class Level_19_Manage_Data_Cach_Khac extends BaseTest { // bài này đang học trong topic 101 manage data
	// lần này áp dụng cách data driven testing (tuc là lưu trữ độc lập ko nằm trong source code - ko nằm trong java mà đc lưu trong 1 loại file khác nhu xml, propties, json, excel)
