...
public class Level_17_Pattern_Object extends BaseTest { // bài này đại ý nói về việc viết script cho 1 trang web có nhiều field để test thì nó sẽ rất dài, ta phải tìm cách cho nó gọn lại
	// nhóm 1 số cái có nhiều điểm chung chung lại rồi làm theo cách format %s như đã học ở phần dynamic locator
