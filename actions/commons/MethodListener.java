...
public class MethodListener implements IInvokedMethodListener { // thằng này có nhiệm vụ log ra nhiều cái message lỗi vì thằng assert chỉ throw ra 1 message lỗi
	@Override
