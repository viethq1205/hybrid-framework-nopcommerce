...
public class BasePageFactory {
	...
	protected String getSelectedItemInDropdown(WebDriver driver, String xpathLocator, String textItem) {
		Select select = new Select(getWebElement(driver, xpathLocator));
	...
	protected void checkTheDefaultCheckboxOrRadio(WebDriver driver, String xpathLocator) {
	...
	protected void uncheckTheDefaultCheckbox(WebDriver driver, String xpathLocator) {
		WebElement element = getWebElement(driver, xpathLocator);
		if (element.isSelected()) {
			element.click();
		}
	...
	// thằng factory này khác với basepage thường là chuyền thẳng cái webelement vào, chứ ko tạo biến string như basepage kia
